 ...
 * @author Joack
 */
public class UsuarioCarritoBorrar extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        float total = usuario.getTotalProductPrice(idCodigo);
        
        usuario.recalcTotalPrice(total);
        usuario.deleteItem(idCodigo);
    }
